...
const ResumeDocument = () => {
    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0 translate-y-[4px] rounded-[4px] bg-[#000000]/5 blur-sm" />
            <div className="absolute inset-0 translate-y-[8px] translate-x-[4px] rounded-[4px] bg-[#000000]/5 blur-md" />

            {/* Main paper surface */}
            <div
                className="relative bg-white rounded-[4px] overflow-hidden aspect-[1/1.414]"
                style={{
                    boxShadow:
                        '0 2px 4px rgba(0,0,0,0.03), 0 8px 16px rgba(0,0,0,0.03), 0 16px 32px rgba(0,0,0,0.04), inset 0 0 0 1px rgba(255,255,255,1)',
                }}
            >
...
const PremiumHeroShowcase = () => {
    return (
        ...
        >
            ...
            <div className="absolute -inset-10 bg-gradient-to-br from-[#4338CA]/15 via-[#7C3AED]/10 to-[#22C55E]/10 rounded-3xl blur-[40px] pointer-events-none" />
